...
The core of the {\scshape MedPCPy} library is an object of a particular class called \verb|Analyzer|. It has methods to get the sessions associated with a subject, convert files to .xlsx format, create documents, and compute the appropriate responses and latencies.
...
\begin{figure}[!ht]
    \begin{center}
        \includegraphics[scale=0.5]{indiv-file-lists.png}
    \end{center}
\end{figure}
